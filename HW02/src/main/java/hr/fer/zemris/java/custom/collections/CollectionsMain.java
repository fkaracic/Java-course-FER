...
/**
 * Program {@code CollectionsMain} works with {@code ArrayIndexedCollection} and
 * {@code LinkedListIndexedCollection}. Adds elements to the collections and
 * prints them. Also removes some of the elements.
 * 
...
public class CollectionsMain {
	...
	/**
	 * Method that is called when program is started.
	 * 
	 * @param args command line arguments as array of {@code String}
	 */
